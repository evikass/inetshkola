    ...
    <div className={`fixed bottom-4 right-4 z-50 ${className}`}>
      <AnimatePresence mode="wait">
        {isOpen ? (
          ...
          >
            <Card className="w-80 sm:w-96 h-[500px] flex flex-col bg-gradient-to-b from-indigo-900/95 to-purple-900/95 border-purple-500/30 shadow-2xl backdrop-blur-sm">
              {/* Header */}
              <div className="flex items-center justify-between p-4 border-b border-purple-500/30">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-white">AI Учитель</h3>
              ...
              <div className="p-4 border-t border-purple-500/30">
                <div className="flex gap-2">
                  <Button
                    ...
                    className={`${isListening ? 'text-red-400 animate-pulse' : 'text-purple-300'}`}
                  >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={toggleOpen}
            className="w-16 h-16 rounded-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 shadow-lg flex items-center justify-center group relative"
          >
            <motion.div
            ...
            {/* Pulse effect */}
            <motion.div
              className="absolute inset-0 rounded-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 opacity-50"
              animate={{ scale: [1, 1.3, 1], opacity: [0.5, 0, 0.5] }}
              transition={{ duration: 2, repeat: Infinity }}
            />
            
            {/* Tooltip */}
            <span className="absolute -top-10 left-1/2 -translate-x-1/2 bg-white/90 text-gray-800 px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
              AI Учитель
            </span>
          </motion.button>
        )}
