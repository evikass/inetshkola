...
// Educational Games
export { ArtGame } from './ArtGame'
export { AstronomyGame } from './AstronomyGame'
export { GeometryGame } from './GeometryGame'
export { GeographyRussiaGame } from './GeographyRussiaGame'
export { InformaticsGame } from './InformaticsGame'
export { LiteratureGame } from './LiteratureGame'
export { PhysicsGame } from './PhysicsGame'
export { SocialStudiesGame } from './SocialStudiesGame'
