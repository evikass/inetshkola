...
function GradeCardSkeleton() {
  return (
    <Card className="rounded-2xl sm:rounded-3xl p-3 sm:p-4 aspect-square">
      <div className="flex flex-col items-center justify-center h-full space-y-2">
        <Skeleton className="w-14 h-14 sm:w-18 sm:h-18 rounded-xl bg-white/20" />
      ...
      >
        ...
        <motion.div 
          className="absolute inset-0 opacity-0 group-hover:opacity-100 
            transition-opacity duration-300 rounded-2xl sm:rounded-3xl 
        ...
        {/* Изображение класса */}
        <div className="relative w-14 h-14 sm:w-18 sm:h-18 mb-2 sm:mb-3 z-10">
          <motion.div
        ...
        <h3 className="text-2xl sm:text-3xl font-black text-white text-center 
          drop-shadow-lg relative z-10 mb-1">
          {grade.shortName}
        </h3>

        {/* Описание */}
        <p className="text-[10px] sm:text-xs text-white/90 text-center font-medium relative z-10">
          {style.description}
        </p>

        {/* Бейдж снизу */}
        <motion.div
          className="mt-1.5 sm:mt-2 px-2 py-0.5 rounded-full text-[9px] sm:text-[10px]
