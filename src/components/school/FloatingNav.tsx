...
import { 
  ...
  Star, Target, Settings, User, Home, Users, Heart
} from 'lucide-react'
...
export default function FloatingNav({ activeTab, setActiveTab, selectedGrade = 0 }: FloatingNavProps) {
  ...
  const navItems = isKidMode ? [
    ...
    { id: 'friends', label: 'Друзья', icon: Users, emoji: '👥', color: 'from-cyan-500 to-blue-600' },
    ...
    { id: 'donate', label: 'Поддержка', icon: Heart, emoji: '💖', color: 'from-pink-500 to-rose-600' },
  ] : [
    ...
    { id: 'friends', label: 'Друзья', icon: Users, color: 'from-cyan-500 to-blue-600' },
    ...
    { id: 'donate', label: 'Поддержка', icon: Heart, color: 'from-pink-500 to-rose-600' },
  ]
