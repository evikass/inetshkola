    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className={`grid gap-2 sm:gap-4 ${isKidMode ? 'grid-cols-1 sm:grid-cols-2' : 'grid-cols-2 lg:grid-cols-3'}`}>
        {filteredGames.map((game, index) => (
          ...
          >
            <Card 
              className={`cursor-pointer overflow-hidden group touch-manipulation ${
                isKidMode 
            ...
            >
              ...
              <CardContent className="p-2 sm:p-4">
                <div className="flex items-center gap-1 sm:gap-2 mb-0.5 sm:mb-1">
                  ...
                  <span className="text-[10px] sm:text-xs text-gray-500">{game.categoryLabel}</span>
                </div>
                <h3 className={`font-bold mb-0.5 sm:mb-1 text-sm sm:text-base ${isKidMode ? 'sm:text-xl' : ''}`}>
                  {game.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-0.5 sm:gap-1">
                    <span className="text-[10px] sm:text-xs bg-white/10 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
                      {game.age}
                    </span>
                  </div>
                </div>
