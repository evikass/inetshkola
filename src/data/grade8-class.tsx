...
import { Calculator, Target, Atom, Scroll, Leaf, BookOpen, Languages, Dumbbell, Users, FlaskConical, MapPin, Shield, Globe, Pen, Cloud, Mountain, Scale, Gavel, Wrench, Palette, Music, Monitor } from 'lucide-react'
...
export const grade8Subjects: Subject[] = [
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/physics/phys-05.svg" alt="Внутренняя энергия" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
              ...
              },
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/physics/phys-06.svg" alt="Теплопередача" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/physics/phys-07.svg" alt="Плавление и кристаллизация" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/physics/phys-08.svg" alt="Испарение" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
                  <h2>💨 Испарение</h2>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/physics/phys-09.svg" alt="Тепловой баланс" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
        ...
        topics: [
          {
            ...
            lessons: [
              ...
              },
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/physics/phys-11.svg" alt="Сопротивление" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
                  <h2>🔌 Сопротивление</h2>
                  <h3>R = ρ · l/S</h3>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/physics/phys-12.svg" alt="Работа и мощность" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/chemistry/chem-05.svg" alt="Химическая реакция" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
          ...
          },
          {
            ...
            lessons: [
              ...
              },
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/chemistry/chem-12.svg" alt="Растворы" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/chemistry/chem-13.svg" alt="Моль" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/chemistry/chem-14.svg" alt="Газовые законы" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
        ...
        topics: [
          {
            ...
            theory: `<div style="text-align: center; margin-bottom: 1rem;">
              <img src="/inetshkola/images/topics/history/t9.svg" alt="Пётр I" style="max-width: 100%; height: auto; border-radius: 12px;" />
            </div>
            <h3>Петр I (1682-1725)</h3>
            ...
            lessons: [
              ...
              },
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/history/t9.svg" alt="Северная война" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
        ...
        topics: [
          {
            ...
            theory: `<div style="text-align: center; margin-bottom: 1rem;">
              <img src="/inetshkola/images/topics/history/t10.svg" alt="Екатерина II" style="max-width: 100%; height: auto; border-radius: 12px;" />
            </div>
            <h3>Екатерина II (1762-1796)</h3>
            ...
            lessons: [
              ...
              },
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/history/t10.svg" alt="Внешняя политика" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
  ...
  // ==================== ТЕХНОЛОГИЯ ====================
  {
    ...
    description: 'Проектная деятельность, робототехника',
    sections: [
      {
        id: 'tech8-s1',
        title: 'Проектная деятельность',
        description: 'Основы проектирования',
        order: 1,
        topics: [
          {
            id: 'tech8-s1-t1',
            title: 'Проектирование изделий',
            description: 'Этапы проектной работы',
            theory: `<h3>Проектная деятельность</h3>
            <p>Проект — это плановая работа по созданию нового продукта.</p>
            <h4>Этапы проекта:</h4>
            <ol>
              <li><b>Постановка проблемы</b> — что нужно сделать?</li>
              <li><b>Исследование</b> — сбор информации</li>
              <li><b>Проектирование</b> — разработка решения</li>
              <li><b>Изготовление</b> — создание изделия</li>
              <li><b>Защита проекта</b> — презентация результата</li>
            </ol>
            <h4>Виды проектов:</h4>
            <ul>
            ...
            examples: ['Составь план проекта', 'Какие этапы проекта ты знаешь?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 30,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>5 этапов проекта:</h3>
                  <ol>
                    <li>❓ Постановка проблемы</li>
                    <li>🔍 Исследование</li>
                    <li>✏️ Проектирование</li>
                    <li>🔧 Изготовление</li>
                    <li>🎤 Защита проекта</li>
                  </ol>
                  <div class="tip">💡 Хороший проект решает реальную проблему!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'tech8-s1-t1-q1',
                question: 'Какой первый этап проекта?',
                options: ['Изготовление', 'Постановка проблемы', 'Защита', 'Исследование'],
                correctAnswer: 1,
                explanation: 'Первый этап — постановка проблемы (что нужно сделать).',
                difficulty: 'easy',
                points: 10
              },
              {
                ...
                options: ['Случайная работа', 'Плановая работа по созданию продукта', 'Отдых', 'Игра'],
                correctAnswer: 1,
                explanation: 'Проект — плановая работа по созданию нового продукта.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'tech8-s1-t1-q3',
                question: 'Какой этап последний?',
                options: ['Проектирование', 'Изготовление', 'Защита проекта', 'Исследование'],
                correctAnswer: 2,
                explanation: 'Последний этап — защита (презентация) проекта.',
                difficulty: 'easy',
                points: 10
              }
            ]
      ...
      },
      {
        id: 'tech8-s2',
        title: 'Робототехника',
        description: 'Основы конструирования',
        order: 2,
        topics: [
          {
            id: 'tech8-s2-t1',
            title: 'Основы робототехники',
            description: 'Конструирование и программирование',
            theory: `<h3>Робототехника</h3>
            <p>Робототехника — наука о создании и применении роботов.</p>
            <h4>Компоненты робота:</h4>
            <ul>
              <li><b>Механическая часть</b> — корпус, двигатели, передачи</li>
              <li><b>Электроника</b> — датчики, контроллеры</li>
              <li><b>Программное обеспечение</b> — программа управления</li>
            </ul>
            <h4>Виды датчиков:</h4>
            <ul>
              <li>Датчик касания</li>
              <li>Датчик расстояния</li>
              <li>Датчик света</li>
              <li>Гироскоп</li>
            </ul>`,
            examples: ['Из каких частей состоит робот?', 'Для чего нужны датчики?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 35,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <h2>🤖 Робототехника</h2>
                  <h3>Из чего состоит робот:</h3>
                  <ul>
                    <li>⚙️ Механика — корпус, моторы</li>
                    <li>🔌 Электроника — датчики, платы</li>
                    <li>💻 Программа — управление</li>
                  </ul>
                  <h3>Датчики:</h3>
                  <p>Робот "чувствует" мир через датчики!</p>
                  <div class="tip">💡 Роботы помогают людям в опасных и сложных работах!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'tech8-s2-t1-q1',
                question: 'Что изучает робототехника?',
                options: ['Историю', 'Создание роботов', 'Литературу', 'Географию'],
                correctAnswer: 1,
                explanation: 'Робототехника изучает создание и применение роботов.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'tech8-s2-t1-q2',
                question: 'Для чего нужны датчики?',
                options: ['Для красоты', 'Для восприятия мира', 'Для веса', 'Для скорости'],
                correctAnswer: 1,
                explanation: 'Датчики позволяют роботу "чувствовать" окружающий мир.',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      {
        ...
        options: ['Изготовление', 'Постановка проблемы', 'Защита', 'Исследование'],
        correctAnswer: 1,
        explanation: 'Первый этап — постановка проблемы.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'tech8-q2',
        question: 'Из чего состоит робот?',
        options: ['Только механики', 'Механики, электроники, программы', 'Только программы', 'Только электроники'],
        correctAnswer: 1,
        explanation: 'Робот состоит из механической части, электроники и программного обеспечения.',
        difficulty: 'easy',
        points: 10
      },
      {
        ...
        options: ['Датчик касания', 'Датчик расстояния', 'Гироскоп', 'Датчик света'],
        correctAnswer: 1,
        explanation: 'Датчик расстояния измеряет, как далеко объект.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== ИЗО ====================
  {
    ...
    color: 'text-rose-400',
    gradient: 'from-rose-500 to-pink-500',
    description: 'Изобразительное искусство: живопись, графика, ДПИ',
    sections: [
      {
        id: 'art8-s1',
        title: 'Живопись',
        ...
        topics: [
          {
            id: 'art8-s1-t1',
            title: 'Цветоведение',
            description: 'Основы цвета',
            theory: `<h3>Цветоведение</h3>
            <p>Цвет — важнейшее средство выразительности в живописи.</p>
            ...
            <h4>Составные цвета:</h4>
            <ul>
              <li>Красный + Жёлтый = Оранжевый</li>
              <li>Жёлтый + Синий = Зелёный</li>
              <li>Красный + Синий = Фиолетовый</li>
            </ul>
            <h4>Тёплые и холодные цвета:</h4>
            <ul>
              <li><b>Тёплые</b>: красный, оранжевый, жёлтый</li>
              <li><b>Холодные</b>: синий, зелёный, фиолетовый</li>
            </ul>`,
            examples: ['Какие цвета тёплые?', 'Как получить зелёный цвет?'],
            completed: false,
            difficulty: 'easy',
            estimatedTime: 25,
            lessons: [
              {
                id: 'art8-s1-t1-l1',
                title: 'Основные и составные цвета',
                content: `<div class="lesson">
                  <h2>🎨 Цветоведение</h2>
                  <h3>Основные цвета:</h3>
                  <p>🔴 Красный + 🟡 Жёлтый + 🔵 Синий</p>
                  <h3>Составные цвета:</h3>
                  <p>🟠 Оранжевый = Красный + Жёлтый</p>
                  <p>🟢 Зелёный = Жёлтый + Синий</p>
                  <p>🟣 Фиолетовый = Красный + Синий</p>
                  <div class="tip">💡 Тёплые цвета ассоциируются с солнцем и огнём!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                ...
                options: ['Красный, зелёный, синий', 'Красный, жёлтый, синий', 'Оранжевый, зелёный, фиолетовый', 'Белый, чёрный, серый'],
                correctAnswer: 1,
                explanation: 'Основные цвета: красный, жёлтый, синий.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'art8-s1-t1-q2',
                question: 'Какой цвет получится: жёлтый + синий?',
                options: ['Оранжевый', 'Фиолетовый', 'Зелёный', 'Красный'],
                correctAnswer: 2,
              ...
              },
              {
                ...
                options: ['Синий, зелёный', 'Красный, оранжевый', 'Фиолетовый, синий', 'Белый, чёрный'],
                correctAnswer: 1,
                explanation: 'Тёплые цвета: красный, оранжевый, жёлтый.',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      {
        id: 'art8-q1',
        question: 'Какие цвета основные?',
        options: ['Красный, зелёный, синий', 'Красный, жёлтый, синий', 'Оранжевый, зелёный', 'Белый, чёрный'],
        correctAnswer: 1,
        explanation: 'Основные цвета: красный, жёлтый, синий.',
        difficulty: 'easy',
        points: 10
      ...
      {
        id: 'art8-q2',
        question: 'Как получить фиолетовый?',
        options: ['Красный + жёлтый', 'Красный + синий', 'Жёлтый + синий', 'Белый + чёрный'],
        correctAnswer: 1,
        explanation: 'Фиолетовый = красный + синий.',
        difficulty: 'easy',
        points: 10
      },
      {
        ...
        correctAnswer: 2,
        explanation: 'Синий — холодный цвет.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== МУЗЫКА ====================
  {
    ...
    color: 'text-cyan-400',
    gradient: 'from-cyan-500 to-blue-500',
    description: 'Музыкальное искусство: жанры, стили, история',
    sections: [
      {
        id: 'music8-s1',
        title: 'Музыкальные жанры',
        description: 'Классификация музыки',
        order: 1,
        topics: [
          {
            id: 'music8-s1-t1',
            ...
            <p>Жанр — это вид музыкальных произведений.</p>
            <h4>Основные жанры:</h4>
            <ul>
              <li><b>Песня</b> — вокальное произведение с инструментальным сопровождением</li>
              <li><b>Симфония</b> — крупное оркестровое произведение</li>
              <li><b>Опера</b> — музыкально-драматическое произведение</li>
              <li><b>Балет</b> — музыкально-хореографическое представление</li>
              <li><b>Концерт</b> — произведение для солиста с оркестром</li>
            </ul>
            <h4>Вокальные жанры:</h4>
            <ul>
              <li>Песня, романс, ария, хоровое пение</li>
            </ul>
            <h4>Инструментальные жанры:</h4>
            <ul>
              <li>Соната, симфония, концерт, сюита</li>
            </ul>`,
            examples: ['Назови вокальный жанр', 'Что такое симфония?'],
            completed: false,
            difficulty: 'easy',
            estimatedTime: 25,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Вокальные:</h3>
                  <p>🎤 Песня, романс, ария, хор</p>
                  <h3>Инструментальные:</h3>
                  <p>🎻 Симфония, соната, концерт</p>
                  <h3>Театральные:</h3>
                  <p>🎭 Опера, балет, мюзикл</p>
                  <div class="tip">💡 Жанр определяет форму и содержание музыки!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                ...
                options: ['Песня', 'Музыкально-драматическое произведение', 'Танец', 'Инструментальное произведение'],
                correctAnswer: 1,
                explanation: 'Опера — музыкально-драматическое произведение для певцов и оркестра.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'music8-s1-t1-q2',
                question: 'Какой жанр вокальный?',
                options: ['Симфония', 'Песня', 'Концерт', 'Соната'],
                correctAnswer: 1,
                explanation: 'Песня — вокальный жанр (поётся голосом).',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'music8-s1-t1-q3',
                question: 'Балет — это...',
                options: ['Песня', 'Оркестровая музыка', 'Музыкально-хореографическое представление', 'Инструментальная пьеса'],
                correctAnswer: 2,
                explanation: 'Балет — музыкально-хореографическое (танцевальное) представление.',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      {
        id: 'music8-q1',
        question: 'Что такое опера?',
        options: ['Танец', 'Музыкально-драматическое произведение', 'Инструмент', 'Песня'],
        correctAnswer: 1,
        explanation: 'Опера — музыкально-драматическое произведение.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'music8-q2',
        question: 'Какой жанр инструментальный?',
        options: ['Ария', 'Романс', 'Симфония', 'Песня'],
        correctAnswer: 2,
        explanation: 'Симфония — инструментальный жанр для оркестра.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'music8-q3',
        question: 'Балет сочетает музыку с...',
        options: ['Пением', 'Танцем', 'Чтением', 'Рисунком'],
        correctAnswer: 1,
        explanation: 'Балет сочетает музыку с танцем (хореографией).',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== ИНФОРМАТИКА ====================
  {
    ...
    description: 'Программирование, алгоритмы, информационные технологии',
    sections: [
      {
        id: 'inf8-s1',
        ...
        topics: [
          {
            ...
            theory: `<h3>Язык Python</h3>
            <p>Python — популярный язык программирования.</p>
            <h4>Первая программа:</h4>
            <code>print("Привет, мир!")</code>
            <h4>Основные команды:</h4>
            <ul>
              <li><b>print()</b> — вывод на экран</li>
              <li><b>input()</b> — ввод данных</li>
              <li><b>int()</b> — преобразование в число</li>
              <li><b>str()</b> — преобразование в строку</li>
            </ul>
            <h4>Переменные:</h4>
            <code>name = "Иван"</code><br>
            <code>age = 14</code>`,
            examples: ['Напиши программу вывода имени', 'Что делает print?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 35,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <p><code>print("Привет!")</code></p>
                  <h3>Переменные:</h3>
                  <p><code>name = "Аня"</code></p>
                  <p><code>age = 14</code></p>
                  <h3>Ввод данных:</h3>
                  <p><code>name = input("Имя: ")</code></p>
                  <div class="tip">💡 Python — простой и понятный язык для начинающих!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 20
            ...
            quiz: [
              {
                ...
                options: ['Вводит данные', 'Выводит на экран', 'Создаёт переменную', 'Удаляет данные'],
                correctAnswer: 1,
                explanation: 'print() выводит текст на экран.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'inf8-s1-t1-q2',
                question: 'Как создать переменную с именем?',
                options: ['print(name)', 'name = "Иван"', 'input(name)', 'var name'],
                correctAnswer: 1,
                explanation: 'Переменная создаётся: имя = значение.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'inf8-s1-t1-q3',
                question: 'Для чего нужна команда input()?',
                options: ['Вывод', 'Ввод данных', 'Удаление', 'Копирование'],
                correctAnswer: 1,
                explanation: 'input() используется для ввода данных с клавиатуры.',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      {
        ...
        options: ['Вводит', 'Выводит', 'Удаляет', 'Копирует'],
        correctAnswer: 1,
        explanation: 'print() выводит текст на экран.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'inf8-q2',
        question: 'Python — это...',
        options: ['Игра', 'Язык программирования', 'Программа', 'Сайт'],
        correctAnswer: 1,
        explanation: 'Python — язык программирования.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'inf8-q3',
        question: 'Как ввести данные?',
        options: ['print()', 'input()', 'write()', 'type()'],
        correctAnswer: 1,
        explanation: 'input() — команда для ввода данных.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== ОБЖ ====================
  {
    ...
    description: 'Основы безопасности: чрезвычайные ситуации, первая помощь',
    sections: [
      {
        id: 'safety8-s1',
        title: 'Чрезвычайные ситуации',
        description: 'Правила поведения в ЧС',
        order: 1,
        topics: [
          {
            id: 'safety8-s1-t1',
            title: 'Виды чрезвычайных ситуаций',
            description: 'Классификация ЧС',
            theory: `<h3>Чрезвычайные ситуации</h3>
            <p>ЧС — обстоятельства, угрожающие жизни и здоровью людей.</p>
            <h4>Виды ЧС:</h4>
            <ul>
              <li><b>Природные</b>: наводнения, землетрясения, ураганы</li>
              <li><b>Техногенные</b>: аварии, пожары, взрывы</li>
              <li><b>Социальные</b>: терроризм, массовые беспорядки</li>
            </ul>
            <h4>Действия при ЧС:</h4>
            <ol>
              <li>Сохранять спокойствие</li>
              <li>Оценить обстановку</li>
              <li>Позвонить 112</li>
              <li>Выполнить рекомендации спасателей</li>
            </ol>`,
            examples: ['Какие виды ЧС ты знаешь?', 'Что делать при землетрясении?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 30,
            lessons: [
              {
                ...
                title: 'Виды ЧС',
                content: `<div class="lesson">
                  <h2>⚠️ Чрезвычайные ситуации</h2>
                  <h3>Природные:</h3>
                  <p>🌊 Наводнения, 🌋 землетрясения, 🌪️ ураганы</p>
                  <h3>Техногенные:</h3>
                  <p>💥 Аварии, 🔥 пожары, ☢️ радиационные аварии</p>
                  <h3>Действия:</h3>
                  <ol>
                    <li>Спокойствие!</li>
                    <li>Оценка обстановки</li>
                    <li>Звонок 112</li>
                    <li>Следовать инструкциям</li>
                  </ol>
                  <div class="tip">💡 Единый номер экстренных служб — 112!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'safety8-s1-t1-q1',
                question: 'Какой номер экстренных служб?',
              ...
              {
                id: 'safety8-s1-t1-q2',
                question: 'Наводнение — это ЧС...',
                options: ['Техногенная', 'Природная', 'Социальная', 'Бытовая'],
                correctAnswer: 1,
                explanation: 'Наводнение — природная чрезвычайная ситуация.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'safety8-s1-t1-q3',
                question: 'Первое действие при ЧС?',
                options: ['Бежать', 'Сохранять спокойствие', 'Паниковать', 'Прятаться'],
                correctAnswer: 1,
                explanation: 'При ЧС нужно сохранять спокойствие и оценить обстановку.',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      ...
      {
        id: 'safety8-q2',
        question: 'Авария на заводе — это ЧС...',
        options: ['Природная', 'Техногенная', 'Социальная', 'Природная'],
        correctAnswer: 1,
        explanation: 'Аварии на производстве — техногенные ЧС.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'safety8-q3',
        question: 'Что делать при ЧС?',
        options: ['Паниковать', 'Сохранять спокойствие и позвонить 112', 'Бежать без оглядки', 'Игнорировать'],
        correctAnswer: 1,
        explanation: 'При ЧС нужно сохранять спокойствие и вызвать помощь.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== ОСНОВЫ ПРАВА ====================
  {
    ...
    description: 'Конституция РФ, права и обязанности граждан',
    sections: [
      {
        id: 'law8-s1',
        title: 'Конституция РФ',
        description: 'Основной закон страны',
        order: 1,
        topics: [
          {
            id: 'law8-s1-t1',
            title: 'Что такое Конституция',
            description: 'Основной закон',
            theory: `<h3>Конституция Российской Федерации</h3>
            <p>Конституция — основной закон государства.</p>
            <h4>Особенности Конституции:</h4>
            <ul>
              <li>Высшая юридическая сила</li>
              <li>Законы не могут противоречить Конституции</li>
              <li>Принята всенародным голосованием 12 декабря 1993 года</li>
            </ul>
            <h4>Основные права граждан:</h4>
            <ul>
            ...
            examples: ['Когда принята Конституция?', 'Какие права гарантирует Конституция?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 30,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Что такое Конституция?</h3>
                  <p>📜 Основной закон государства</p>
                  <h3>Когда принята?</h3>
                  ...
                  <div class="tip">💡 Конституция имеет высшую силу! Все законы должны ей соответствовать.</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              ...
              },
              {
                id: 'law8-s1-t1-q2',
                question: 'Что такое Конституция?',
                options: ['Обычный закон', 'Основной закон государства', 'Правила школы', 'Соглашение'],
                correctAnswer: 1,
                explanation: 'Конституция — основной закон государства с высшей юридической силой.',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'law8-s1-t1-q3',
                question: 'Какое право гарантирует Конституция?',
                options: ['Право на игры', 'Право на жизнь', 'Право на сладости', 'Право на отдых'],
                correctAnswer: 1,
                explanation: 'Конституция гарантирует право на жизнь — важнейшее право человека.',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      {
        id: 'law8-q1',
        question: 'Когда принята Конституция РФ?',
        options: ['1991', '1993', '2000', '1995'],
        correctAnswer: 1,
        explanation: 'Конституция принята 12 декабря 1993 года.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'law8-q2',
        question: 'Конституция имеет...',
        options: ['Низшую силу', 'Высшую юридическую силу', 'Нет силы', 'Одинаковую силу с другими законами'],
        correctAnswer: 1,
        explanation: 'Конституция имеет высшую юридическую силу.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'law8-q3',
        question: 'Какое право в Конституции?',
        options: ['Право на сладости', 'Право на образование', 'Право на машину', 'Право на путешествия'],
        correctAnswer: 1,
        explanation: 'Право на образование гарантировано Конституцией.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== БИОЛОГИЯ ====================
  {
    ...
    description: 'Организм человека, системы органов',
    sections: [
      {
        id: 'bio8-s1',
        title: 'Организм человека',
        description: 'Строение и функции организма',
        order: 1,
        topics: [
          {
            id: 'bio8-s1-t1',
            title: 'Общий обзор организма',
            description: 'Уровни организации живого',
            theory: `<h3>Организм человека</h3>
            <p>Человеческий организм — сложная биологическая система, состоящая из взаимосвязанных органов и тканей.</p>
            <h4>Уровни организации:</h4>
            <ul>
              <li><b>Молекулярный</b> — молекулы белков, жиров, углеводов, ДНК</li>
              <li><b>Клеточный</b> — клетки (эпителиальные, мышечные, нервные)</li>
              <li><b>Тканевый</b> — группы клеток (эпителиальная, соединительная, мышечная, нервная)</li>
              <li><b>Органный</b> — органы (сердце, лёгкие, печень)</li>
              <li><b>Системный</b> — системы органов (пищеварительная, кровеносная)</li>
              <li><b>Организменный</b> — целый организм</li>
            </ul>
            <h4>Гомеостаз:</h4>
            <p>Постоянство внутренней среды организма</p>`,
            examples: ['Назови уровни организации', 'Что такое гомеостаз?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 30,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <div style="text-align: center; margin-bottom: 1rem;">
                    <img src="/inetshkola/images/topics/chemistry/chem-01.svg" alt="Организм" style="max-width: 100%; height: auto; border-radius: 12px;" />
                  </div>
                  <h2>🧬 Уровни организации</h2>
                  <h3>Иерархия:</h3>
                  <ol>
                    <li>Молекулы → Клетки → Ткани</li>
                    <li>Ткани → Органы → Системы</li>
                    <li>Системы → Организм</li>
                  </ol>
                  <h3>Пример:</h3>
                  <p>Молекулы белка → Мышечная клетка → Мышечная ткань → Сердце → Кровеносная система → Организм</p>
                  <div class="tip">💡 Каждый уровень имеет свои свойства!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'bio8-s1-t1-q1',
                question: 'Какой уровень организации выше?',
                options: ['Клеточный', 'Тканевый', 'Органный', 'Молекулярный'],
                correctAnswer: 2,
                explanation: 'Органный уровень выше клеточного и тканевого!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'bio8-s1-t1-q2',
                question: 'Сколько основных типов тканей у человека?',
                options: ['2', '3', '4', '5'],
                correctAnswer: 2,
                explanation: '4 типа тканей: эпителиальная, соединительная, мышечная, нервная!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'bio8-s1-t1-q3',
                question: 'Что такое гомеостаз?',
                options: ['Болезнь', 'Постоянство внутренней среды', 'Рост организма', 'Размножение'],
                correctAnswer: 1,
                explanation: 'Гомеостаз — постоянство внутренней среды организма!',
                difficulty: 'medium',
                points: 15
              }
            ]
          },
          {
            id: 'bio8-s1-t2',
            title: 'Кровеносная система',
            description: 'Строение и функции крови',
            theory: `<h3>Кровеносная система</h3>
            <h4>Состав крови:</h4>
            <ul>
              <li><b>Эритроциты</b> — красные кровяные клетки, переносят кислород</li>
              <li><b>Лейкоциты</b> — белые кровяные клетки, защищают от инфекций</li>
              <li><b>Тромбоциты</b> — кровяные пластинки, участвуют в свёртывании</li>
              <li><b>Плазма</b> — жидкая часть крови (90% вода)</li>
            </ul>
            <h4>Функции крови:</h4>
            <ul>
              <li>Транспортная — перенос кислорода и питательных веществ</li>
              <li>Защитная — иммунитет</li>
              <li>Терморегуляторная — распределение тепла</li>
            </ul>
            <h4>Группы крови:</h4>
            <p>I (0), II (A), III (B), IV (AB) + резус-фактор (+/-)</p>`,
            examples: ['Какую функцию выполняют эритроциты?', 'Сколько групп крови существует?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 35,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <h2>🩸 Состав крови</h2>
                  <h3>Эритроциты:</h3>
                  <p>Красные клетки без ядра, содержат гемоглобин</p>
                  <p>Переносят O₂ от лёгких к тканям</p>
                  <h3>Лейкоциты:</h3>
                  <p>Белые клетки с ядром</p>
                  <p>Фагоцитоз — поглощение бактерий</p>
                  <h3>Тромбоциты:</h3>
                  <p>Участвуют в свёртывании крови</p>
                  <div class="tip">💡 Эритроциты живут ~120 дней!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
              },
              {
                ...
                content: `<div class="lesson">
                  <h2>❤️ Круги кровообращения</h2>
                  <h3>Большой круг:</h3>
                  <p>Левый желудочек → Аорта → Ткани → Вены → Правое предсердие</p>
                  <h3>Малый круг:</h3>
                  <p>Правый желудочек → Лёгочные артерии → Лёгкие → Лёгочные вены → Левое предсердие</p>
                  <h3>Сердце:</h3>
                  <p>4 камеры: 2 предсердия, 2 желудочка</p>
                  <div class="tip">💡 Полный цикл кровообращения — ~23 секунды!</div>
                </div>`,
                completed: false,
                order: 2,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'bio8-s1-t2-q1',
                question: 'Какие клетки переносят кислород?',
                options: ['Лейкоциты', 'Тромбоциты', 'Эритроциты', 'Плазма'],
                correctAnswer: 2,
                explanation: 'Эритроциты содержат гемоглобин и переносят кислород!',
                difficulty: 'easy',
                points: 10
              },
              {
                ...
                options: ['2', '3', '4', '6'],
                correctAnswer: 2,
                explanation: 'Сердце имеет 4 камеры: 2 предсердия и 2 желудочка!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'bio8-s1-t2-q3',
                question: 'Какой белок придаёт крови красный цвет?',
                options: ['Миоглобин', 'Гемоглобин', 'Альбумин', 'Фибриноген'],
                correctAnswer: 1,
                explanation: 'Гемоглобин содержит железо и придаёт крови красный цвет!',
                difficulty: 'medium',
                points: 15
              }
            ]
          },
          {
            ...
            description: 'Органы пищеварения',
            theory: `<h3>Пищеварительная система</h3>
            <h4>Органы пищеварения:</h4>
            <ul>
              <li><b>Ротовая полость</b> — механическая обработка, начало переваривания углеводов</li>
              <li><b>Пищевод</b> — проведение пищи в желудок</li>
              <li><b>Желудок</b> — переваривание белков (пепсин, соляная кислота)</li>
              <li><b>Тонкий кишечник</b> — основное переваривание и всасывание</li>
              <li><b>Толстый кишечник</b> — всасывание воды, формирование каловых масс</li>
            </ul>
            <h4>Пищеварительные железы:</h4>
            <ul>
              <li><b>Слюнные железы</b> — амилаза (расщепляет крахмал)</li>
              <li><b>Печень</b> — желчь (эмульгация жиров)</li>
              <li><b>Поджелудочная железа</b> — ферменты для всех компонентов пищи</li>
            </ul>`,
            examples: ['Где начинается переваривание белков?', 'Какую функцию выполняет печень?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 35,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <h2>🍎 Пищеварительная система</h2>
                  <h3>Путь пищи:</h3>
                  <ol>
                    <li>Рот → пережёвывание, слюна</li>
                    <li>Пищевод → проведение</li>
                    <li>Желудок → переваривание белков</li>
                    <li>Тонкий кишечник → всасывание</li>
                    <li>Толстый кишечник → вода</li>
                  </ol>
                  <h3>Всасывание:</h3>
                  <p>В тонком кишечнике — ворсинки увеличивают площадь</p>
                  <div class="tip">💡 Длина тонкого кишечника — 5-7 метров!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'bio8-s1-t3-q1',
                question: 'Где начинается переваривание белков?',
                options: ['Во рту', 'В желудке', 'В кишечнике', 'В печени'],
                correctAnswer: 1,
                explanation: 'В желудке пепсин начинает переваривание белков!',
                difficulty: 'medium',
                points: 15
              },
              {
                id: 'bio8-s1-t3-q2',
                question: 'Какой орган вырабатывает желчь?',
                options: ['Желудок', 'Поджелудочная железа', 'Печень', 'Кишечник'],
                correctAnswer: 2,
                explanation: 'Печень вырабатывает желчь для эмульгации жиров!',
                difficulty: 'medium',
                points: 15
              },
              {
                id: 'bio8-s1-t3-q3',
                question: 'В каком отделе происходит основное всасывание?',
                options: ['Желудок', 'Тонкий кишечник', 'Толстый кишечник', 'Пищевод'],
                correctAnswer: 1,
                explanation: 'Тонкий кишечник имеет ворсинки для всасывания питательных веществ!',
                difficulty: 'easy',
                points: 10
              }
            ]
        ...
        topics: [
          {
            ...
            <h4>Структура:</h4>
            <ul>
              <li><b>ЦНС</b> — центральная нервная система (головной и спинной мозг)</li>
              <li><b>ПНС</b> — периферическая нервная система (нервы и нервные узлы)</li>
            </ul>
            <h4>Нейрон:</h4>
            <ul>
              <li><b>Тело</b> — с ядром и органоидами</li>
              <li><b>Дендриты</b> — короткие отростки (вход сигналов)</li>
              <li><b>Аксон</b> — длинный отросток (выход сигнала)</li>
            </ul>
            <h4>Нервный импульс:</h4>
            <p>Электрический сигнал, передающийся по нервному волокну</p>
            <h4>Синапс:</h4>
            <p>Место контакта между нейронами, медиаторы</p>`,
            examples: ['Из чего состоит нейрон?', 'Что такое синапс?'],
            completed: false,
            difficulty: 'hard',
            estimatedTime: 40,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Строение:</h3>
                  <ul>
                    <li>Тело клетки — ядро, цитоплазма</li>
                    <li>Дендриты — приём сигналов</li>
                    <li>Аксон — передача сигнала</li>
                  </ul>
                  <h3>Типы нейронов:</h3>
                  <ul>
                    <li>Чувствительные — от органов к ЦНС</li>
                    <li>Двигательные — от ЦНС к мышцам</li>
                    <li>Вставочные — между нейронами</li>
                  </ul>
                  <div class="tip">💡 В мозге около 86 миллиардов нейронов!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'bio8-s2-t1-q1',
                question: 'Какой отросток нейрона передаёт сигнал?',
                options: ['Дендрит', 'Аксон', 'Тело', 'Ядро'],
                correctAnswer: 1,
                explanation: 'Аксон — длинный отросток, передающий сигнал от тела нейрона!',
                difficulty: 'medium',
                points: 15
              },
              {
                id: 'bio8-s2-t1-q2',
                question: 'Что такое ЦНС?',
                options: ['Периферические нервы', 'Головной и спинной мозг', 'Мышцы', 'Кровеносные сосуды'],
                correctAnswer: 1,
                explanation: 'ЦНС — центральная нервная система (головной и спинной мозг)!',
                difficulty: 'easy',
                points: 10
              },
              {
                ...
                options: ['Тип нейрона', 'Место контакта нейронов', 'Часть мозга', 'Тип нерва'],
                correctAnswer: 1,
                explanation: 'Синапс — место контакта между нейронами для передачи сигнала!',
                difficulty: 'medium',
                points: 15
              }
            ]
          },
          {
            id: 'bio8-s2-t2',
            title: 'Головной мозг',
            description: 'Отделы мозга',
            theory: `<h3>Головной мозг</h3>
            <h4>Отделы:</h4>
            <ul>
              <li><b>Продолговатый мозг</b> — дыхание, кровообращение</li>
              <li><b>Мозжечок</b> — координация движений, равновесие</li>
              <li><b>Средний мозг</b> — ориентировочные рефлексы</li>
              <li><b>Промежуточный мозг</b> — таламус, гипоталамус (гомеостаз)</li>
              <li><b>Большие полушария</b> — высшая нервная деятельность</li>
            </ul>
            <h4>Кора больших полушарий:</h4>
            <ul>
              <li><b>Лобная доля</b> — мышление, речь, движение</li>
              <li><b>Теменная доля</b> — осязание, пространственная ориентация</li>
              <li><b>Височная доля</b> — слух, память</li>
              <li><b>Затылочная доля</b> — зрение</li>
            </ul>`,
            examples: ['Какую функцию выполняет мозжечок?', 'Где находится зрительная зона?'],
            completed: false,
            difficulty: 'hard',
            estimatedTime: 40,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Ствол мозга:</h3>
                  <ul>
                    <li>Продолговатый — дыхание, сердце</li>
                    <li>Средний — рефлексы</li>
                    <li>Промежуточный — таламус, гипоталамус</li>
                  </ul>
                  <h3>Мозжечок:</h3>
                  <p>Координация движений и равновесие</p>
                  <h3>Большие полушария:</h3>
                  <p>Покрыты корой — высшие функции</p>
                  <div class="tip">💡 Мозг весит ~1.4 кг и потребляет 20% кислорода!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'bio8-s2-t2-q1',
                question: 'Какой отдел отвечает за координацию движений?',
                options: ['Продолговатый мозг', 'Мозжечок', 'Лобная доля', 'Таламус'],
                correctAnswer: 1,
              ...
              {
                id: 'bio8-s2-t2-q2',
                question: 'Где находится зрительная зона коры?',
                options: ['Лобная доля', 'Теменная доля', 'Височная доля', 'Затылочная доля'],
                correctAnswer: 3,
                explanation: 'Затылочная доля отвечает за обработку зрительной информации!',
                difficulty: 'medium',
                points: 15
              },
              {
                id: 'bio8-s2-t2-q3',
                question: 'Какой отдел контролирует дыхание?',
                options: ['Мозжечок', 'Продолговатый мозг', 'Кора', 'Таламус'],
                correctAnswer: 1,
                explanation: 'Продолговатый мозг содержит центры дыхания и кровообращения!',
                difficulty: 'medium',
                points: 15
              }
            ]
        ...
        topics: [
          {
            ...
            description: 'Строение костей',
            theory: `<h3>Скелет</h3>
            <p>Скелет человека состоит из ~206 костей.</p>
            <h4>Отделы скелета:</h4>
            <ul>
              <li><b>Скелет головы</b> — череп (мозговой и лицевой)</li>
              <li><b>Скелет туловища</b> — позвоночник (33-34 позвонка), грудная клетка</li>
              <li><b>Скелет конечностей</b> — пояса и свободные конечности</li>
            </ul>
            <h4>Типы костей:</h4>
            <ul>
              <li><b>Трубчатые</b> — длинные кости (бедренная, плечевая)</li>
              <li><b>Губчатые</b> — короткие кости (позвонки, запястье)</li>
              <li><b>Плоские</b> — кости черепа, лопатки, рёбра</li>
            </ul>
            <h4>Состав кости:</h4>
            <p>Органические вещества (эластичность) + Неорганические (прочность)</p>`,
            examples: ['Сколько костей в скелете?', 'Какие типы костей бывают?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 35,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Позвоночник:</h3>
                  <ul>
                    <li>Шейный отдел — 7 позвонков</li>
                    <li>Грудной отдел — 12 позвонков</li>
                    <li>Поясничный отдел — 5 позвонков</li>
                    <li>Крестцовый — 5 сросшихся</li>
                    <li>Копчиковый — 4-5 сросшихся</li>
                  </ul>
                  <h3>Изгибы:</h3>
                  <p>Лордозы (впереди), кифозы (назад)</p>
                  <div class="tip">💡 Изгибы позвоночника — амортизация при ходьбе!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                ...
                options: ['5', '7', '12', '33'],
                correctAnswer: 1,
                explanation: 'У человека 7 шейных позвонков — как у жирафа и мыши!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'bio8-s3-t1-q2',
                question: 'Какие кости относятся к трубчатым?',
                options: ['Позвонки', 'Рёбра', 'Бедренная кость', 'Кости черепа'],
                correctAnswer: 2,
                explanation: 'Бедренная кость — трубчатая, длинная кость!',
                difficulty: 'medium',
                points: 15
              },
              {
                id: 'bio8-s3-t1-q3',
                question: 'Какое вещество придаёт кости эластичность?',
                options: ['Кальций', 'Фосфор', 'Органические вещества', 'Вода'],
                correctAnswer: 2,
                explanation: 'Органические вещества (белок оссеин) придают эластичность!',
                difficulty: 'medium',
                points: 15
              }
            ]
          },
          {
            id: 'bio8-s3-t2',
            title: 'Мышцы',
            description: 'Работа мышц',
            theory: `<h3>Мышечная система</h3>
            <h4>Типы мышц:</h4>
            <ul>
              <li><b>Скелетные</b> — поперечнополосатые, произвольные (~600 мышц)</li>
              <li><b>Гладкие</b> — стенки органов, непроизвольные</li>
              <li><b>Сердечная</b> — поперечнополосатая, непроизвольная</li>
            </ul>
            <h4>Работа мышц:</h4>
            <ul>
              <li>Сокращение — укорачивание мышечных волокон</li>
              <li>Расслабление — возвращение в исходное состояние</li>
              <li>Антагонисты — мышцы с противоположным действием</li>
              <li>Синергисты — мышцы с одинаковым действием</li>
            </ul>
            <h4>Энергия:</h4>
            <p>АТФ — основной источник энергии для сокращения</p>`,
            examples: ['Сколько скелетных мышц?', 'Что такое антагонисты?'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 30,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <h2>💪 Мышцы</h2>
                  <h3>Строение мышцы:</h3>
                  <ul>
                    <li>Мышечные волокна — клетки</li>
                    <li>Миофибриллы — сократительные нити</li>
                    <li>Сухожилия — прикрепление к костям</li>
                  </ul>
                  <h3>Динамическая работа:</h3>
                  <p>Движение (бег, ходьба)</p>
                  <h3>Статическая работа:</h3>
                  <p>Удержание позы</p>
                  <div class="tip">💡 Самая сильная мышца — жевательная, самая длинная — портняжная!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'bio8-s3-t2-q1',
                question: 'Какие мышцы управляются произвольно?',
                options: ['Гладкие', 'Сердечная', 'Скелетные', 'Все'],
                correctAnswer: 2,
                explanation: 'Скелетные мышцы управляются произвольно по нашему желанию!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'bio8-s3-t2-q2',
                question: 'Что такое мышцы-антагонисты?',
                options: ['Работают вместе', 'Имеют противоположное действие', 'Одинаковы по силе', 'Находятся рядом'],
                correctAnswer: 1,
                explanation: 'Антагонисты — мышцы с противоположным действием (сгибатель/разгибатель)!',
                difficulty: 'medium',
                points: 15
              },
              {
                id: 'bio8-s3-t2-q3',
                question: 'Что является источником энергии для сокращения?',
                options: ['Кислород', 'Глюкоза', 'АТФ', 'Белок'],
                correctAnswer: 2,
                explanation: 'АТФ (аденозинтрифосфат) — универсальный источник энергии!',
                difficulty: 'medium',
                points: 15
              }
            ]
    ...
    quiz: [
      {
        id: 'bio8-q1',
        question: 'Сколько типов тканей у человека?',
        options: ['2', '3', '4', '5'],
        correctAnswer: 2,
        explanation: '4 типа: эпителиальная, соединительная, мышечная, нервная.',
        difficulty: 'easy',
        points: 10
      },
      {
        ...
        options: ['Лейкоциты', 'Тромбоциты', 'Эритроциты', 'Плазма'],
        correctAnswer: 2,
        explanation: 'Эритроциты с гемоглобином переносят кислород.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'bio8-q3',
        question: 'Где перевариваются белки?',
        options: ['Рот', 'Желудок', 'Кишечник', 'Печень'],
        correctAnswer: 1,
        explanation: 'Пепсин в желудке расщепляет белки.',
        difficulty: 'medium',
        points: 15
      },
      {
        id: 'bio8-q4',
        question: 'Сколько камер в сердце?',
        options: ['2', '3', '4', '6'],
        correctAnswer: 2,
      ...
      {
        id: 'bio8-q5',
        question: 'Какой отдел мозга отвечает за координацию?',
        options: ['Продолговатый', 'Мозжечок', 'Кора', 'Средний'],
        correctAnswer: 1,
        explanation: 'Мозжечок координирует движения.',
        difficulty: 'medium',
        points: 15
      },
      {
        id: 'bio8-q6',
        question: 'Сколько шейных позвонков?',
        options: ['5', '7', '12', '33'],
        correctAnswer: 1,
        explanation: '7 шейных позвонков.',
        difficulty: 'easy',
        points: 10
      },
      {
        ...
        options: ['Миоглобин', 'Гемоглобин', 'Альбумин', 'Фибриноген'],
        correctAnswer: 1,
        explanation: 'Гемоглобин с железом.',
        difficulty: 'medium',
        points: 15
      },
      {
        ...
        options: ['Дендрит', 'Аксон', 'Тело', 'Ядро'],
        correctAnswer: 1,
        explanation: 'Аксон передаёт сигнал от тела.',
        difficulty: 'medium',
        points: 15
      },
      {
        id: 'bio8-q9',
        question: 'Какие мышцы непроизвольные?',
        options: ['Скелетные', 'Гладкие', 'Все', 'Никакие'],
        correctAnswer: 1,
        explanation: 'Гладкие и сердечная — непроизвольные.',
        difficulty: 'easy',
        points: 10
      },
      {
        id: 'bio8-q10',
        question: 'Где находится зрительная зона?',
        options: ['Лобная доля', 'Височная доля', 'Затылочная доля', 'Теменная доля'],
        correctAnswer: 2,
        explanation: 'В затылочной доле.',
        difficulty: 'medium',
        points: 15
      },
      {
        id: 'bio8-q11',
        question: 'Что такое гомеостаз?',
        options: ['Болезнь', 'Постоянство среды', 'Рост', 'Размножение'],
        correctAnswer: 1,
        explanation: 'Постоянство внутренней среды.',
        difficulty: 'medium',
        points: 15
      },
      {
        ...
        options: ['Желудок', 'Печень', 'Поджелудочная', 'Кишечник'],
        correctAnswer: 1,
        explanation: 'Печень вырабатывает желчь.',
        difficulty: 'medium',
        points: 15
      }
    ]
