...
import { Calculator, Target, Atom, Scroll, Leaf, BookOpen, Languages, Dumbbell, Users, FlaskConical, MapPin, Shield, Globe, Pen, Cloud, Mountain, Scale, Gavel, Monitor, Wrench, Palette, Music } from 'lucide-react'
...
export const grade8Subjects: Subject[] = [
        ...
        topics: [
          {
            ...
            <p>Алгоритм — это точное описание последовательности действий для решения задачи.</p>
            <h4>Свойства алгоритма:</h4>
            <ul>
              <li><b>Понятность</b> — команды понятны исполнителю</li>
              <li><b>Определённость</b> — каждая команда однозначна</li>
            ...
            examples: ['Приведи пример алгоритма из жизни', 'Какие свойства алгоритма?'],
            completed: false,
            difficulty: 'easy',
            estimatedTime: 25,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  <h2>🔄 Алгоритм</h2>
                  <p>Алгоритм — точное описание последовательности действий.</p>
                  <h3>Примеры:</h3>
                  <ul>
                    <li>Рецепт приготовления блюда</li>
                    <li>Инструкция по сборке</li>
                    <li>План решения задачи</li>
                  </ul>
                  <h3>Свойства:</h3>
                  <p>Понятность, определённость, результативность, массовость, дискретность</p>
                  <div class="tip">💡 Алгоритм должен быть точным и понятным!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                ...
                options: ['Набор чисел', 'Последовательность действий', 'Формула', 'Таблица'],
                correctAnswer: 1,
                explanation: 'Алгоритм — точное описание последовательности действий для решения задачи!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'info8-s1-t1-q2',
                question: 'Какое свойство означает "приводит к результату"?',
                options: ['Понятность', 'Массовость', 'Результативность', 'Дискретность'],
                correctAnswer: 2,
    ...
    quiz: [
      {
        ...
        options: ['100', '1000', '1024', '1048'],
        correctAnswer: 2,
        explanation: '1 Кбайт = 1024 байт.',
        difficulty: 'medium',
        points: 15
      }
    ]
  ...
  // ==================== ОБЖ ====================
  {
    ...
    color: 'text-orange-400',
    gradient: 'from-orange-500 to-red-500',
    description: 'Безопасность в чрезвычайных ситуациях',
    sections: [
      {
        id: 'obzh8-s1',
        title: 'Чрезвычайные ситуации',
        description: 'Виды ЧС и действия при них',
        order: 1,
        topics: [
          {
            id: 'obzh8-s1-t1',
            ...
            <h4>По происхождению:</h4>
            <ul>
              <li><b>Природные</b> — землетрясения, наводнения, ураганы</li>
              <li><b>Техногенные</b> — аварии на производстве</li>
              <li><b>Биолого-социальные</b> — эпидемии</li>
            </ul>
            <h4>Действия при ЧС:</h4>
            <ol>
              <li>Сохранять спокойствие</li>
              <li>Оценить обстановку</li>
              <li>Сообщить в службы спасения (112)</li>
              <li>Действовать по инструкции</li>
            </ol>`,
            ...
            lessons: [
              {
                id: 'obzh8-s1-t1-l1',
                title: 'Классификация ЧС',
                content: `<div class="lesson">
                  <h2>⚠️ Чрезвычайные ситуации</h2>
                  <h3>Природные:</h3>
                  <p>Землетрясения, наводнения, ураганы, пожары</p>
                  <h3>Техногенные:</h3>
                  <p>Аварии на производстве, транспорте</p>
                  <h3>Действия:</h3>
                  <ol>
                    <li>Сохранять спокойствие</li>
                    <li>Позвонить 112</li>
                    <li>Эвакуироваться</li>
                  </ol>
                  <div class="tip">💡 Главное — не паниковать!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'obzh8-s1-t1-q1',
                question: 'К какому виду ЧС относится наводнение?',
                options: ['Техногенная', 'Природная', 'Биологическая', 'Социальная'],
                correctAnswer: 1,
    ...
    quiz: [
      {
        ...
        options: ['Бежать', 'Позвонить 101 или 112', 'Скрыться', 'Игнорировать'],
        correctAnswer: 1,
        explanation: 'При пожаре нужно позвонить 101 или 112 и эвакуироваться.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== ТЕХНОЛОГИЯ ====================
  {
    ...
    description: 'Электротехника, 3D-моделирование, технологии',
    sections: [
      {
        id: 'tech8-s1',
        title: 'Электротехника',
        description: 'Основы электричества',
        order: 1,
        topics: [
          {
            id: 'tech8-s1-t1',
            title: 'Электрические цепи',
            description: 'Элементы цепи',
            theory: `<h3>Электрическая цепь</h3>
            <h4>Основные элементы:</h4>
            <ul>
              <li><b>Источник тока</b> — батарейка, генератор</li>
              <li><b>Проводники</b> — провода</li>
              <li><b>Потребители</b> — лампочки, приборы</li>
              <li><b>Выключатель</b> — замыкает/размыкает цепь</li>
            </ul>
            <h4>Правила безопасности:</h4>
            <ul>
              <li>Не касаться оголённых проводов</li>
              <li>Работать при выключенном питании</li>
              <li>Использовать изолированные инструменты</li>
            </ul>`,
            examples: ['Назови элементы электрической цепи', 'Правила безопасности с электричеством'],
            completed: false,
            difficulty: 'medium',
            estimatedTime: 30,
            lessons: [
              {
                id: 'tech8-s1-t1-l1',
                title: 'Элементы электрической цепи',
                content: `<div class="lesson">
                  <h2>⚡ Электрическая цепь</h2>
                  <h3>Элементы:</h3>
                  <ul>
                    <li>Источник тока (батарейка)</li>
                    <li>Проводники (провода)</li>
                    <li>Потребители (лампочка)</li>
                    <li>Выключатель</li>
                  </ul>
                  <h3>Условные обозначения:</h3>
                  <p>Гальванический элемент — |┤|</p>
                  <p>Лампочка — ⍉</p>
                  <div class="tip">💡 Цепь должна быть замкнута для работы!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'tech8-s1-t1-q1',
                question: 'Что нужно для работы электрической цепи?',
                options: ['Только батарейка', 'Замкнутая цепь', 'Только провода', 'Только лампочка'],
                correctAnswer: 1,
                explanation: 'Электрическая цепь должна быть замкнута!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'tech8-s1-t1-q2',
                question: 'Что делает выключатель?',
                options: ['Даёт ток', 'Замыкает/размыкает цепь', 'Производит ток', 'Потребляет энергию'],
                correctAnswer: 1,
                explanation: 'Выключатель замыкает и размыкает электрическую цепь!',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      {
        id: 'tech8-q1',
        question: 'Источником тока является:',
        options: ['Лампочка', 'Батарейка', 'Выключатель', 'Провод'],
        correctAnswer: 1,
        explanation: 'Батарейка — источник электрического тока.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== ИЗО ====================
  {
    ...
    color: 'text-pink-400',
    gradient: 'from-pink-500 to-rose-500',
    description: 'Живопись, графика, декоративное искусство',
    sections: [
      {
        id: 'art8-s1',
        title: 'Живопись',
        ...
        topics: [
          {
            ...
            <p>Оранжевый, зелёный, фиолетовый</p>
            <h4>Тёплые и холодные цвета:</h4>
            <ul>
              <li><b>Тёплые</b> — красный, оранжевый, жёлтый</li>
              <li><b>Холодные</b> — синий, зелёный, фиолетовый</li>
            </ul>
            <h4>Цветовой контраст:</h4>
            <p>Противоположные цвета усиливают друг друга</p>`,
            examples: ['Какие цвета основные?', 'Какие цвета тёплые?'],
            completed: false,
            difficulty: 'easy',
            estimatedTime: 25,
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <p>Ж + С = Зелёный</p>
                  <p>С + К = Фиолетовый</p>
                  <h3>Тёплые vs Холодные:</h3>
                  <p>Тёплые: красный, оранжевый, жёлтый</p>
                  <p>Холодные: синий, зелёный, фиолетовый</p>
                  <div class="tip">💡 Контрастные цвета усиливают друг друга!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                ...
                options: ['Оранжевый, зелёный, фиолетовый', 'Красный, жёлтый, синий', 'Белый, чёрный, серый', 'Красный, зелёный, синий'],
                correctAnswer: 1,
    ...
    quiz: [
      {
        ...
        options: ['Синий', 'Зелёный', 'Оранжевый', 'Фиолетовый'],
        correctAnswer: 2,
        explanation: 'Оранжевый — тёплый цвет.',
        difficulty: 'easy',
        points: 10
      }
    ]
  ...
  // ==================== МУЗЫКА ====================
  {
    ...
    description: 'Музыкальная грамота, музыкальные стили',
    sections: [
      {
        id: 'music8-s1',
        title: 'Музыкальная грамота',
        description: 'Нотация и ритм',
        order: 1,
        topics: [
          {
            id: 'music8-s1-t1',
            title: 'Нотная грамота',
            description: 'Ноты и их длительности',
            theory: `<h3>Нотная грамота</h3>
            <h4>Ноты:</h4>
            <p>До, Ре, Ми, Фа, Соль, Ля, Си (C, D, E, F, G, A, B)</p>
            <h4>Длительности нот:</h4>
            <ul>
              <li><b>Целая</b> — 4 счёта</li>
              <li><b>Половинная</b> — 2 счёта</li>
              <li><b>Четвертная</b> — 1 счёт</li>
              <li><b>Восьмая</b> — ½ счёта</li>
            </ul>
            <h4>Нотный стан:</h4>
            <p>5 линеек, на которых записываются ноты</p>`,
            examples: ['Назови все ноты', 'Какая длительность длиннее?'],
            completed: false,
            difficulty: 'easy',
            estimatedTime: 25,
            lessons: [
              {
                id: 'music8-s1-t1-l1',
                title: 'Ноты и их длительности',
                content: `<div class="lesson">
                  <h2>🎼 Нотная грамота</h2>
                  <h3>Ноты:</h3>
                  <p>До, Ре, Ми, Фа, Соль, Ля, Си</p>
                  <h3>Длительности:</h3>
                  <ul>
                    <li>Целая — ○ (4 счёта)</li>
                    <li>Половинная — ○ с палочкой (2 счёта)</li>
                    <li>Четвертная — ♩ (1 счёт)</li>
                    <li>Восьмая — ♪ (½ счёта)</li>
                  </ul>
                  <div class="tip">💡 Чем больше палочка/хвостик, тем короче нота!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
            ...
            quiz: [
              {
                id: 'music8-s1-t1-q1',
                question: 'Сколько счётов в четвертной ноте?',
                options: ['4', '2', '1', '½'],
                correctAnswer: 2,
                explanation: 'Четвертная нота — 1 счёт!',
                difficulty: 'easy',
                points: 10
              },
              {
                id: 'music8-s1-t1-q2',
                question: 'Какая нота самая длинная?',
                options: ['Восьмая', 'Четвертная', 'Половинная', 'Целая'],
                correctAnswer: 3,
                explanation: 'Целая нота — самая длинная (4 счёта)!',
                difficulty: 'easy',
                points: 10
              }
            ]
    ...
    quiz: [
      {
        id: 'music8-q1',
        question: 'Сколько линеек на нотном стане?',
        options: ['3', '4', '5', '7'],
        correctAnswer: 2,
        explanation: 'На нотном стане 5 линеек.',
        difficulty: 'easy',
        points: 10
      }
    ]
