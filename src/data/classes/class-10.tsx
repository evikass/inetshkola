...
import { Calculator, Target, Book, Atom, FlaskConical, Users, Leaf, Cpu, BookOpen, Languages } from 'lucide-react'
...
export const grade10: Grade = {
  ...
  subjects: [
    ...
    // ==================== РУССКИЙ ЯЗЫК ====================
    {
      ...
      description: 'Культура речи, стилистика',
      topics: [
        {
          id: 't1',
          title: 'Стили речи',
          ...
          <h4>Научный стиль:</h4>
          <ul>
            <li>Точность, логичность, терминология</li>
            <li>Статьи, учебники, доклады</li>
          </ul>
          <h4>Официально-деловой:</h4>
          <ul>
            <li>Стандартность, безличность</li>
            <li>Заявления, приказы, законы</li>
          </ul>
          <h4>Публицистический:</h4>
          <ul>
            <li>Эмоциональность, призывность</li>
            <li>Статьи, репортажи, интервью</li>
          </ul>
          <h4>Художественный:</h4>
          <ul>
            <li>Образность, эмоциональность</li>
            <li>Романы, рассказы, стихи</li>
          </ul>
          <h4>Разговорный:</h4>
          <ul>
            <li>Непринуждённость, диалогичность</li>
            <li>Беседы, письма, SMS</li>
          </ul>`,
          examples: ['Определи стиль текста', 'Признаки научного стиля', 'Особенности разговорного стиля'],
          completed: false,
          difficulty: 'medium',
          estimatedTime: 30
        }
      ...
      quiz: [
        {
          id: 'q1',
          question: 'Какой стиль используется для написания законов?',
          options: ['Научный', 'Художественный', 'Официально-деловой', 'Разговорный'],
          correctAnswer: 2,
          explanation: 'Официально-деловой стиль используется для написания законов, приказов, заявлений.',
          difficulty: 'easy',
          points: 10
        }
      ]
    ...
    // ==================== ЛИТЕРАТУРА ====================
    {
      ...
      color: 'text-purple-400',
      gradient: 'from-purple-500 to-pink-500',
      description: 'Русская литература XIX-XX веков',
      topics: [
        {
          id: 't1',
          title: 'Ф.М. Достоевский',
          description: '"Преступление и наказание"',
          theory: `<h3>📖 "Преступление и наказание"</h3>
          <h4>Роман (1866)</h4>
          <h4>Герои:</h4>
          <ul>
          ...
          <h4>Главная мысль:</h4>
          <p>Нельзя строить счастье на чужом горе. Путь к спасению — через раскаяние и любовь.</p>`,
          examples: ['Теория Раскольникова', 'Образ Сони', 'Почему Раскольников признался?'],
          completed: false,
          difficulty: 'hard',
          estimatedTime: 45
        }
      ...
      quiz: [
        {
          ...
          options: ['Толстой', 'Достоевский', 'Тургенев', 'Гоголь'],
          correctAnswer: 1,
          explanation: '"Преступление и наказание" — роман Ф.М. Достоевского, опубликованный в 1866 году.',
          difficulty: 'easy',
          points: 10
        }
      ]
    ...
    // ==================== ИНОСТРАННЫЙ ЯЗЫК ====================
    {
      ...
      color: 'text-cyan-400',
      gradient: 'from-cyan-500 to-blue-500',
      description: 'Английский язык: Upper-Intermediate',
      topics: [
        {
          id: 't1',
          title: 'Modal Verbs',
          ...
          <p><em>You should have studied harder.</em></p>`,
          examples: ['Переведи с модальным глаголом', 'Perfect Modal', 'Выбери правильный модальный глагол'],
          completed: false,
          difficulty: 'medium',
          estimatedTime: 30
        }
      ...
      quiz: [
        {
          id: 'q1',
          question: 'Что означает "must have done"?',
          options: ['Запрещено делать', 'Должно быть, сделал', 'Должен сделать', 'Не сделал'],
          correctAnswer: 1,
          explanation: 'Must have done — вывод о прошлом: "должно быть, сделал" (вероятность).',
          difficulty: 'medium',
          points: 15
        }
      ]
