            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <ul>
                    ...
                    <li>1881 — конец выкупной операции</li>
                  </ul>
                  <h3>Условия:</h3>
                  <p>Выкуп = 20% крестьянин + 80% государство</p>
                  <p>Отрезки = до 20% земли потеряли</p>
                  <div class="tip">💡 "Великие реформы" изменили Россию!</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 20
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Итог:</h3>
                  <p>Более 1000 убитых</p>
                  <p>Начало революции</p>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Результат:</h3>
                  <p>Прорыв австрийского фронта, спасение Франции</p>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>Место:</h3>
                  <p>Станция Дно, Псков</p>
                  <h3>Причина:</h3>
                  <p>Потеря поддержки армии и общества</p>
            ...
            lessons: [
              {
                ...
                content: `<div class="lesson">
                  ...
                  <h3>О мире:</h3>
                  <p>Выход из войны без аннексий</p>
                  <h3>О земле:</h3>
                  <p>Отмена частной собственности на землю</p>
                  <h3>О власти:</h3>
                  <p>Вся власть Советам</p>
                  <div class="tip">💡 "Мир — народам, земля — крестьянам!"</div>
                </div>`,
                completed: false,
                order: 1,
                estimatedTime: 15
